...
// import { search } from '../../../../servers/controleadmin/controlstudent'
// import controlwork from './controleadmin/controlwork';
...
export default function Student() {
    ...
    const filteredData = data.filter((item)=>{
        return(
            ...
            (item.lastName && String(item.lastName).toLowerCase().includes(searchTerm.toLowerCase()))
