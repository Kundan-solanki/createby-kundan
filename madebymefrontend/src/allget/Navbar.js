        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul className="navbar-nav">
              ...
              <li>
                {/* <Link className="navbar-brand fs-3 font-8" to="/registation">Registration</Link> */}
           ...
           <div className="dropdown ">
              ...
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <Link id='logoutin' className="nav-link active fs-5 text-success" aria-current="page"  onClick={()=>logoutuserperson()}>Logout ({JSON.parse(auth)?.name})</Link>
                </li>
              </ul>
            </ul>
